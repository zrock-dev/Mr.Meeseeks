...
class GameControllerTest {
    ...
    */
    ...
    void lessThan() {
        ...
        assertTrue(gameController.compareNumbers(minorNumber, hiddenNumber));
        // prints:
    }
    ...
    void moreThan() {
        ...
        assertTrue(gameController.compareNumbers(moreThanHiddenNumber, hiddenNumber));
    }

    @Test
    void bothEqual(){
        assertFalse(gameController.compareNumbers(hiddenNumber, hiddenNumber));
    }
}